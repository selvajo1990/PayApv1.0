table 50101 "Employee Level Air Ticket"
{
    DataClassification = CustomerContent;
    Caption = 'Employee Level Air Ticket';
    LookupPageId = "Employee Level Air Ticket";
    DrillDownPageId = "Employee Level Air Ticket";
    fields
    {
        ...
        field(2; "Air Ticket Group Code"; Text[50])
        {
            DataClassification = CustomerContent;
        ...
        field(4; "Air Ticket Code"; Code[20])
        {
            DataClassification = CustomerContent;
            Caption = 'Air Ticket Code';
        }
    ...
    keys
    {
        key(PK; "Employee No.", "Air Ticket Group Code", "From Date", "Air Ticket Code")
        {
            Clustered = true;
        }
    }
